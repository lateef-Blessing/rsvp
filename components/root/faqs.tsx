  ...
  return (
    ...
    >
      <div className="container">
        ...
        <div className="-mx-4 max-w-7xl px-4 sm:px-6 lg:px-8 mt-10">
          <div className="accordion-group">
            {/* Accordion Item */}
            <div
              className={`accordion border border-solid border-bgPrimary p-4 rounded-xl transition duration-500 mb-8 lg:p-4 ${
                openSection === 1 ? "border-bgPrimary" : ""
              }`}
            >
              <button
            ...
            <div
              className={`accordion border border-solid border-bgPrimary p-4 rounded-xl transition duration-500 mb-8 lg:p-4 ${
                openSection === 2 ? "border-bgPrimary" : ""
              }`}
            >
              <button
            ...
            <div
              className={`accordion border border-solid border-bgPrimary p-4 rounded-xl transition duration-500 mb-8 lg:p-4 ${
                openSection === 3 ? "border-bgPrimary" : ""
              }`}
            >
              <button
            ...
            <div
              className={`accordion border border-solid border-bgPrimary p-4 rounded-xl transition duration-500 mb-8 lg:p-4 ${
                openSection === 4 ? "border-bgPrimary" : ""
              }`}
            >
              <button
            ...
            <div
              className={`accordion border border-solid border-bgPrimary p-4 rounded-xl transition duration-500 mb-8 lg:p-4 ${
                openSection === 5 ? "border-bgPrimary" : ""
              }`}
            >
              <button
            ...
            <div
              className={`accordion border border-solid border-bgPrimary p-4 rounded-xl transition duration-500 mb-8 lg:p-4 ${
                openSection === 6 ? "border-bgPrimary" : ""
              }`}
            >
              <button
