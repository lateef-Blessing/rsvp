...
const AttendeesConfirmIcon = () => (
  <span role="img" aria-label="Attendees Confirm" className="text-[40px] text-center">
    ✅
  </span>
);
...
const EveryoneWinsIcon = () => (
  <span role="img" aria-label="Everyone Wins" className="text-[40px] text-center">
    🏆
  </span>
);
    ...
    <section className="py-10 md:py-[60px]" id="workflow">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          >
            {/* 1st item */}
            <div className="relative flex flex-col items-start px-4 rounded-xl py-[30px] shadow-md sm:px-[30px] bg-zinc-400/10">
